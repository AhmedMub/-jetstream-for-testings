            ...
            <div class="card-body bg-white px-5 py-3 border-bottom rounded-top">
                <div class="mx-3 my-3">
                    ...
                    <h3 class="h3 my-4">
                        ...
                        this changes are in branch two from main
                    </h3>
                            ...
                            <div class="ps-3">
                                <div class="mb-2">
                                    <a href="https://laravel.com/docs"
                                        class="h5 font-weight-bolder text-decoration-none text-dark">Documentation</a>
                                </div>
                                <p class="text-muted">
                            ...
                            <div class="ps-3">
                                <div class="mb-2">
                                    <a href="https://laracasts.com"
                                        class="h5 font-weight-bolder text-decoration-none text-dark">Laracasts</a>
                                </div>
                                <p class="text-muted">
                            ...
                            <div class="ps-3">
                                <div class="mb-2">
                                    <a href="https://getbootstrap.com/"
                                        class="h5 font-weight-bolder text-decoration-none text-dark">Bootstrap</a>
                                </div>
                                <p class="text-muted">
                    ...
                    <div class="card-body p-3 h-100">
                        <div class="d-flex flex-row bd-highlight mb-3">
                            ...
                            <div class="ps-3">
                                <div class="mb-2">
                                    <span
                                        class="h5 font-weight-bolder text-decoration-none text-dark">Authentication</span>
                                </div>
                                <p class="text-muted">
